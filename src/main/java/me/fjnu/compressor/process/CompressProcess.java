...
public interface CompressProcess {
	 ...
	 * @throws IOException
	 */
	byte[] compress(byte srcBytes[]) throws IOException, InvalidParamsException;
	 ...
	 * @throws IOException
	 */
	byte[] uncompress(byte[] bytes) throws DataFormatException, IOException, InvalidParamsException, InvalidInputEncodedDataFileException;
}
